...
import 'package:app_core_module/core/app_dialog.dart';
...
class AppReadMoreText extends StatefulWidget {
  ...
  @override
  AppReadMoreTextState createState() => AppReadMoreTextState();
}
...
class AppReadMoreTextState extends State<AppReadMoreText> {
  bool _readMore = true;
  ...
  void _onTapLink() {
    setState(() {
      ...
      if (widget.showMoreInDialog ?? false) {
        showLongTextDialog(
          context,
          content: widget.data,
          style: widget.style,
  ...
  void showLongTextDialog(BuildContext context,
